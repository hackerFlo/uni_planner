...
function CalendarHeader() {
  return (
    <header className="flex w-full items-center gap-1 pb-1">
      <Button
        slot="previous"
        className="flex size-9 items-center justify-center rounded-lg text-zinc-400 outline-offset-2 transition-colors hover:bg-zinc-100 hover:text-zinc-700 focus:outline-none data-[focus-visible]:outline data-[focus-visible]:outline-2 data-[focus-visible]:outline-indigo-300"
      >
        <ChevronLeft size={16} strokeWidth={2} />
      </Button>
      <Heading className="grow text-center text-sm font-semibold text-zinc-800" />
      <Button
        slot="next"
        className="flex size-9 items-center justify-center rounded-lg text-zinc-400 outline-offset-2 transition-colors hover:bg-zinc-100 hover:text-zinc-700 focus:outline-none data-[focus-visible]:outline data-[focus-visible]:outline-2 data-[focus-visible]:outline-indigo-300"
      >
...
function CalendarGridComponent() {
  ...
  return (
    <CalendarGrid>
      <CalendarGridHeader>
        {(day) => (
          <CalendarHeaderCell className="size-9 rounded-lg p-0 text-xs font-medium text-zinc-400">
            {day}
          </CalendarHeaderCell>
        )}
      </CalendarGridHeader>
